...
SRC_URI = "${GNU_MIRROR}/gcc/releases/gcc-${PV}/gcc-${PV}.tar.bz2 \
	file://gcc-3.3.6-arm-bigendian.patch;patch=1 \
	file://gcc-3.3.6-arm-softfloat.patch;patch=1 \
	file://gcc-3.3.6-iwmmxt.patch;patch=1 \
	file://zecke-xgcc-cpp.patch;patch=1   \
	file://mvl-gcc-3.3-arm-iwmmxt-local.patch;patch=1 \
	file://mvl-gcc-3.3-arm-iwmmxt-recog.patch;patch=1 \
	file://mvl-gcc-3.3-arm-iwmmxt-regsave.patch;patch=1 "
