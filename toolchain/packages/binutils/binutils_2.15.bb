...
SECTION = "devel"
LICENSE = "GPL"
MAINTAINER = "Freyther <freyther@gmit-gmbh.de>"
PR = "r3"
...
SRC_URI = \
    "${GNU_MIRROR}/binutils/binutils-${PV}.tar.bz2 \
     file://binutils-2.15-psignal.patch;patch=1 \
     file://binutils-2.15-solaris-qsort.patch;patch=1 \
     file://binutils-2.15-vmx.patch;patch=1 \
     file://binutils-arm-undef-imm.patch;patch=1 \
     file://binutils-skip-comments.patch;patch=1 \
     file://cross-gprof.patch;patch=1 \
     file://gccpr15247-fix.patch;patch=1 \
     file://s390-invalid-insn-format.patch;patch=1 "
